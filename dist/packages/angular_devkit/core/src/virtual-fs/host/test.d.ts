...
export declare class TestHost extends SimpleMemoryHost {
    ...
    protected _list(path: Path): import("packages/angular_devkit/core/src/virtual-fs/path").PathFragment[];
    ...
    $list(path: string): import("packages/angular_devkit/core/src/virtual-fs/path").PathFragment[];
